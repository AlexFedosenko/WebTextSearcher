...
public abstract class AsyncTask<Params, Progress, Result> {
     ...
     * obscure data loss and stability issues. Such changes are best executed in serial; to guarantee such work is serialized regardless of platform version you can use this function.
     *
     * <p>
     * This method must be invoked on the UI thread.
     *
